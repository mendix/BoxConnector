...
import static boxconnector.proxies.microflows.Microflows.getFileCollaborationsImpl;
...
/**
 * Use this to get a list of all the collaborations on a file i.e. all of the users that have access to that folder.
 * 
 * Required
